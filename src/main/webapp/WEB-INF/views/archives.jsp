				...
				<div class="col-sm-10">
					<div class="row">
						<div class="top_title_section">
							...
							<div class="col-sm-6 ">
								<a href=" " class=" export btn theme-btn detail_download_btn">
									<img src="<%=request.getContextPath()%>/static/assets/img/dashboard/download.png"
							...
							<div class="content-table">
											...
											<a role="button" class="nohover"
												...
												<div class="head-content row">
													...
													<div class="updown-arrow-holder"
														...
														<img src="<%=request.getContextPath()%>/static/assets/img/dashboard/filter.png"
													...
													<div class="filter_holder d-none">
														...
														<button class="light-button filter-button"
															...
															<img src="<%=request.getContextPath()%>/static/assets/img/dashboard/check-box-checked.png">
															VR
														</button>
														<br>
														<button class="light-button filter-button"
														...
														<button class="light-button filter-button"
															...
															<input type="checkbox" value="training" id="training" checked> <img
														...
														<span class=" calender-icon"><img
															src="<%=request.getContextPath()%>/static/assets/img/dashboard/calender.png" alt=""></span> <input
															type="text" name="daterange" class="date-picker" />
													</div>
												</div>
											</a>
										</h4>
								...
								<div class="panel-group" id="accordion" role="tablist"
									...
									<div class="panel panel-default filter ar training"
											...
											<h4 class="panel-title">
												...
												<div class="head-content row">
													<a role="button" class="nohover" data-toggle="collapse"
														data-parent="#accordion" href="#collapse2${item.id}"
														aria-expanded="true" aria-controls="collapse2${item.id}">

														<div class="avatar-holder">
															<img class="img img-thumbnail avatar"  src="<%=request.getContextPath()%>/static/assets/img/profile/no-profile.jpeg" />
														</div>
														<div class="name-holder">
															<h4 class="avatar_name">${item.employee_name}</h4>
														</div>
														<div class="emp-id-holder">
															<h5>${item.employee_id}</h5>
														</div>
														<div class="date-holder">
															<h5>${item.date_taken}</h5>
														</div>
														<div class="type-holder">
															<h5>${item.type}</h5>
														</div>
													...
													<div class="menu-img-holder" data-toggle="collapse"
														href="#collapse2${item.id}" aria-expanded="true"
														aria-controls="collapse2${item.id}">
														<div class="dropdown">
															<button
																class="btn dropdown-toggle download_btn content-menu-btn d-none"
																type="button" data-toggle="dropdown">
																<img src="<%=request.getContextPath()%>/static/assets/img/dashboard/menu.png">
															</button>
															<ul class="dropdown-menu add_record">
																<li><a href="<%=request.getContextPath()%>/archivesProcess/${item.id}/0/0"
																	class="dropdown_menu_item restore_btn" data-id="2">Restore
																		Session</a></li>
															</ul>
														</div>
													</div>
													<div class="updown-arrow-holder">
														<img src="<%=request.getContextPath()%>/static/assets/img/sidebar/arrow_head.png"
															class="img img-thumbnail img-responsive arrow_head"
															data-toggle="collapse" href="#collapse2${item.id}"
															aria-expanded="true" aria-controls="collapse2${item.id}">
													</div>
												</div>
												</a>
										...
										<div id="collapse2${item.id}" class="panel-collapse collapse "
											...
											<div class="panel-body">
												<div class="row">
													...
													<div class="time-log-holder">
														<h3 class="time_log">${item.date_taken}</h3>
													</div>
												</div>
												<div class="row">
													...
													<div class="view-all-btn-holder">
														<a href="<%=request.getContextPath()%>/archivesProcess/${item.id}/0/0" data-id="2"
															class="btn theme-btn-2 pull-right viewall_btn restore_btn">
															RESTORE </a>
													</div>
												</div>
											</div>
